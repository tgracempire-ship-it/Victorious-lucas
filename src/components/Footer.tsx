...
export const Footer: React.FC = () => {
  ...
  return (
    <footer className="relative bg-gradient-to-b from-[#FAF7F2] via-[#5C1F28] to-[#2A0D12] text-[#FAF7F2] pt-16 sm:pt-20 pb-20 sm:pb-12 text-sm overflow-hidden border-t border-rose-200/60">
      
      {/* Decorative Milky & Wine Glowing Blobs */}
      <div className="absolute top-0 left-1/4 w-72 h-72 sm:w-96 sm:h-96 bg-[#FAF7F2]/30 rounded-full blur-[140px] pointer-events-none" />
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 space-y-10 sm:space-y-12">
        ...
        <div className="p-5 sm:p-10 rounded-3xl bg-white/95 backdrop-blur-xl border border-rose-200 text-slate-900 shadow-2xl flex flex-col md:flex-row items-center justify-between gap-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-8 sm:gap-10 pt-2">
          ...
          <div className="md:col-span-4 space-y-4 text-center md:text-left">
            <div className="flex items-center justify-center md:justify-start gap-3">
              <img
                ...
                className="w-11 h-11 sm:w-12 sm:h-12 rounded-full object-cover border-2 border-rose-300 shadow-md"
              />
              <div className="text-left">
                <span className="text-lg sm:text-xl font-serif text-white block">
                  {ARTIST_INFO.name}
                </span>
            ...
            <p className="text-xs text-rose-100/80 leading-relaxed font-light max-w-md mx-auto md:mx-0">
          ...
          <div className="md:col-span-4 space-y-4">
            <div className="p-5 sm:p-6 rounded-2xl bg-white/10 border border-white/20 backdrop-blur-md space-y-2 text-center sm:text-left">
              <div className="flex items-center justify-center sm:justify-start gap-2 text-xs font-mono text-rose-200 font-bold uppercase tracking-wider">
        ...
        {/* Bottom Banner */}
        <div className="pt-8 border-t border-rose-900/40 flex flex-col sm:flex-row items-center justify-between gap-3 text-xs text-rose-200/80 font-mono text-center sm:text-left">
          <p>
