        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          <div className="lg:col-span-7 space-y-6">
            ...
            <div className="space-y-4 text-slate-700 text-base leading-relaxed font-light">
              <p className="text-lg font-serif italic text-[#722F37] leading-relaxed">
            ...
            <div className="pt-4 flex flex-wrap items-center gap-4">
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="inline-flex items-center gap-2.5 px-7 py-3 rounded-full bg-[#722F37] text-white font-bold text-xs uppercase tracking-widest shadow-md hover:bg-[#58232B] transition-all cursor-pointer"
              >
              ...
              <a
                href="#booking"
                className="inline-flex items-center gap-2 px-6 py-3 rounded-full bg-white text-slate-800 border border-slate-200 hover:border-[#722F37] hover:text-[#722F37] text-xs font-bold uppercase tracking-wider transition-all shadow-xs"
              >
