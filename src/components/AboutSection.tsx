...
export const AboutSection: React.FC = () => {
  return (
    <section id="about" className="py-24 bg-slate-50 relative overflow-hidden">
      ...
      <div className="absolute bottom-0 left-0 w-96 h-96 bg-slate-300/30 rounded-full blur-[100px] pointer-events-none" />
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          <div className="lg:col-span-5 flex justify-center">
            <div className="relative max-w-sm w-full">
              ...
              <div className="relative rounded-[160px] overflow-hidden border-4 border-slate-200 shadow-xl bg-white aspect-[4/5]">
                <img
                ...
                {/* Overlay Badge */}
                <div className="absolute bottom-6 left-6 right-6 p-4 rounded-2xl bg-white/95 backdrop-blur-md border border-slate-200 space-y-1 shadow-sm">
                  <div className="flex items-center justify-between">
                    ...
                    <a
                      ...
                      target="_blank"
                      rel="noreferrer"
                      className="text-sky-600 text-xs font-semibold hover:text-slate-900 flex items-center gap-1"
                    >
                      <Instagram className="w-3.5 h-3.5" /> @{ARTIST_INFO.igHandle}
                    </a>
                  </div>
                  <h4 className="text-lg font-serif text-slate-900">{ARTIST_INFO.name}</h4>
                  <p className="text-xs text-slate-500">Worship Minister & Songwriter</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="lg:col-span-7 space-y-6">
            ...
            <div className="space-y-4 text-slate-700 text-base leading-relaxed font-light">
              <p className="text-lg font-serif italic text-sky-600 leading-relaxed">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 pt-2">
              <div className="p-5 rounded-2xl bg-white border border-slate-200 space-y-2 shadow-xs">
                <div className="w-9 h-9 rounded-full bg-sky-50 text-sky-600 flex items-center justify-center border border-sky-200">
            ...
            <div className="pt-4 flex flex-wrap items-center gap-4">
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="inline-flex items-center gap-2.5 px-7 py-3 rounded-full bg-sky-600 text-white font-bold text-xs uppercase tracking-widest shadow-md hover:bg-sky-700 transition-all cursor-pointer"
              >
              ...
              <a
                href="#booking"
                className="inline-flex items-center gap-2 px-6 py-3 rounded-full bg-slate-100 text-slate-800 border border-slate-200 hover:border-sky-500 hover:text-sky-600 text-xs font-bold uppercase tracking-wider transition-all"
              >
